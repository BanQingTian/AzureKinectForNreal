...
{
    public static string PoseData = "PoseData";
...
public class MessageManager
{
    ...
    public void SendUpdatePose(string posedata)
    {
        CommondInfo commond = new CommondInfo()
        {
            func = S2CFuncName.PoseData,
            param = posedata,
        };
    ...
    public void SendCreateRoomMsg(string roomName = "gameroom", string roomPassword = "nreal")
    {
